...
class BookedeTablesPage extends StatefulWidget {
  const BookedeTablesPage({super.key});

  @override
  State<BookedeTablesPage> createState() => _BookedeTablesPageState();
}

class _BookedeTablesPageState extends State<BookedeTablesPage> {
  ...
  currentIndex: 1, // questa è la pagina "Prenotazioni"
  selectedItemColor: const Color(0xFF2BB9A9),
  unselectedItemColor: Colors.grey,
  onTap: (index) {
    if (index == 1) return; // sei già qui
